...
<head>
    ...
    <title>
        ...
        {{ option('info_site_title', 'فروشگاه حاج عبدالله') }}
    </title>
            ...
            <div class="container main-container">
                <div class="topbar dt-sl">
                    <div class="row">
                        <div class="col-lg-2 col-md-3 col-6">
                            <div class="logo-area float-right">
                                <a href="{{ route('front.index') }}">
                                    <img data-src="{{ option('info_logo', theme_asset('img/logo.png')) }}" alt="{{ option('info_site_title', 'فروشگاه حاج عبدالله') }}">
                                </a>
                            </div>
                        </div>

                        <div class="col-lg-6 col-md-5 hidden-sm" style="margin-top: 20px;">
                        ...
                        <div class="col-md-4 col-6 topbar-left" style="margin-top: 25px;">
