...
@section('content')
                    ...
                    <div class="ah-tab-wrapper dt-sl">
                        <div class="ah-tab dt-sl">
                            ...
                            @if ($product->description)
                                <a class="ah-tab-item" href="javascript:void(0)"><i class="mdi mdi-glasses"></i>توضیحات محصول</a>
                            @endif

                            @if ($product->specificationGroups()->count())
                                <a class="ah-tab-item" href="javascript:void(0)"><i class="mdi mdi-format-list-checks"></i>ویژگی محصول</a>
                            @endif
    ...
    @if (!$product->addableToCart())
        ...
        <div class="modal fade" id="modal-stock-notify" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                    ...
                                    <form class="form-account" action="#">
                                        <div class="row">
                                            <div class="col-md-6 col-sm-12 mb-2">
                                                ...
                                                <div class="form-row">
                                                    <input class="input-ui pr-2 text-right" type="text" name="name" id="stock-name" placeholder="نام خود را وارد نمایید" required>
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-sm-12 mb-2">
                                                <div class="form-row-title">
                                                ...
                                                <div class="form-row">
                                                    <input class="input-ui pl-2 dir-ltr text-left" type="text" name="mobile" id="stock-mobile" placeholder="09xxxxxxxxx" required>
                                                </div>
                                            </div>
